...
INSERT INTO `film-recommendation-2.tmdb_dataset.film_extended` (id, title, original_title, release_date, popularity, vote_average)
SELECT id, title, original_title, release_date, popularity, vote_average
FROM `tmdb_dataset.movies`
WHERE vote_count>50;
--UPDATE `film-recommendation-2.tmdb_dataset.film_extended`
--SET director = name 
